...
defmodule AshSqlite.DataLayerMetadataTest do
  ...
  test "update_query sets bulk metadata on returned records" do
    ...
    {:ok, results} =
      AshSqlite.DataLayer.update_query(query, changeset, Post, return_records?: true)
  ...
  test "destroy_query sets bulk metadata on returned records" do
    ...
    {:ok, results} =
      AshSqlite.DataLayer.destroy_query(query, changeset, Post, return_records?: true)
